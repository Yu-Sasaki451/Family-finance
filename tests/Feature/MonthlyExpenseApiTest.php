...
class MonthlyExpenseApiTest extends TestCase
{
    ...
    public function test_monthly_and_category_totals_exclude_personal_expenses(): void
    {
        ...
        $this->getJson('/api/expenses/monthly?month=2026-06')
            ...
            ->assertJsonPath('category_totals.0.personal_totals.0.user', '夫')
            ->assertJsonPath('category_totals.0.personal_totals.0.amount', 1500)
            ->assertJsonPath('category_totals.0.personal_totals.1.user', '妻')
            ->assertJsonPath('category_totals.0.personal_totals.1.amount', 500)
