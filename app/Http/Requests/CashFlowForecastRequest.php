...
{
    private const ALLOWED_FORECAST_MONTHS = [3, 6];
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'fixed_incomes.*.amounts' => ['required', 'array', "size:{$forecastMonths}"],
            ...
            'variable_incomes.*.amounts' => ['required', 'array', "size:{$forecastMonths}"],
            ...
            'fixed_expenses.*.amounts' => ['required', 'array', "size:{$forecastMonths}"],
            ...
            'variable_expenses.*.amounts' => ['required', 'array', "size:{$forecastMonths}"],
    ...
    public function messages(): array
    {
        return [
            ...
            'forecast_months.in' => '予測期間は3ヶ月または6ヶ月を選択してください。',
            ...
            'fixed_incomes.*.amounts.size' => '固定収入は選択した月数分入力してください。',
            ...
            'variable_incomes.*.amounts.size' => '変動収入は選択した月数分入力してください。',
            ...
            'fixed_expenses.*.amounts.size' => '固定支出は選択した月数分入力してください。',
